...
public class LightsTests {
	...
	public void sphereSpotBonus() {
		...
		scene.addLights(new SpotLight(new Vector(1, -1, 2), new Color(500, 300, 0), new Point3D(-50, 50, -50), 1,
				0.00001, 0.00000001,4));

		ImageWriter imageWriter = new ImageWriter("sphereSpotBonus", 150, 150, 500, 500);
		Render render = new Render(imageWriter, scene);
	 ...
	 */
	@Test
	public void trianglesSpotBonus() {
		Scene scene = new Scene("Test scene");
		scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
		scene.setDistance(1000);
		scene.setBackground(Color.BLACK);
		...
		ImageWriter imageWriter = new ImageWriter("trianglesSpotBonus", 200, 200, 500, 500);
		Render render = new Render(imageWriter, scene);
	...
	public void sphereAllLights() {
		...
		scene.addLights(new DirectionalLight(new Color(400, 300, 0), new Vector(1, -1, 1)),
				new PointLight(new Color(500, 250, 250), new Point3D(55,55, 100), 1, 0.0005, 0.0005),
