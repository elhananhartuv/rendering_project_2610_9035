...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		scene.addGeometries(
				new Sphere(new Point3D(0, 0, 50), 50, new Color(java.awt.Color.BLUE),
	...
	public void twoSpheresOnMirrors() {
		...
		scene.addGeometries(
				new Sphere(new Point3D(-950, 900, 1000), 400, new Color(0, 0, 100),
						new Material(0.25, 0.25, 20, 0.5, 0)),
				new Sphere(new Point3D(-950, 900, 1000), 200, new Color(100, 20, 20), new Material(0.25, 0.25, 20)),
		...
		scene.addLights(new SpotLight(new Vector(-1, 1, 4), new Color(1020, 400, 400), new Point3D(-750, 750, 150), 1,
				0.00001, 0.000005));
	...
	public void trianglesTransparentSphere() {
		...
		scene.addGeometries( //
				...
				new Sphere(new Point3D(60, -50, 50), 30, new Color(java.awt.Color.BLUE),
