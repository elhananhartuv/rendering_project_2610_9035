...
public class CylinderTests {
	...
	public void testFindIntersections() {
		...
		assertEquals("Worng points", List.of(new GeoPoint(cylinder,new Point3D(1.75, 0, 0)),new GeoPoint(cylinder, new Point3D(1.75, 0, 10))), result);
		...
		if (result.get(0).point.getZ().get() > result.get(1).point.getZ().get())
			result = List.of(result.get(1), result.get(0));
		assertEquals("Worng points", List.of(new GeoPoint(cylinder,new Point3D(1, 0, 3)), new GeoPoint(cylinder,new Point3D(3, 0, 5))), result);
		...
		if (result.get(0).point.getZ().get() > result.get(1).point.getZ().get())
			result = List.of(result.get(1), result.get(0));
		assertEquals("Worng points", List.of(new GeoPoint(cylinder,new Point3D(1, 0, 9)), new GeoPoint(cylinder,new Point3D(2, 0, 10))), result);
		...
		if (result.get(0).point.getZ().get() > result.get(1).point.getZ().get())
			result = List.of(result.get(1), result.get(0));
		assertEquals("Worng points", List.of(new GeoPoint(cylinder,new Point3D(2.5, 0, 0)), new GeoPoint(cylinder,new Point3D(2.5, 0, 10))), result);
		...
		if (result.get(0).point.getX().get() > result.get(1).point.getX().get())
			result = List.of(result.get(1), result.get(0));
		assertEquals("Worng points", List.of(new GeoPoint(cylinder,new Point3D(1, 0, 5)), new GeoPoint(cylinder,new Point3D(3, 0, 5))), result);
